					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="proses-tambah-person.php" method="POST"> 
										<div class="form-group"> 
											<label for="exampleInputEmail1">Nama Penduduk</label> 
											<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Region" name="person_name"> 
										</div>  
									<div class="form-group"> 
										...
										<div class="form-group"> 
											...
											<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Region" name="income"> 
										</div>  
