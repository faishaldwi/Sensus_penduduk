...
<div class="women_main">
	...
	<div class="grids">
					...
					<div class="clearfix"> </div>
					<a href="tambah-region.php"><button style="float:right">Tambah Daerah</button></a><br><br>
		...
		<center>
			<table border="1" width="800">
								...
								<tr>
									...
									<td><?=$name?></td>
									<td><?=$created_at?></td>
									<td><a href="edit-region.php?id=<?=$id?>"><button>Edit</button></a>
										<a href="hapus-region.php?id=<?=$id?>"><button>Hapus</button></a></td>
								</tr>
							<?php } ?>
							</table>
</center>
