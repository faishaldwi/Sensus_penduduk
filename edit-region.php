							...
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									...
									while ($data = mysqli_fetch_array($proses)) {
									 ...
									 ?>
									<form action="proses-edit-region.php" method="POST"> <div class="form-group"> <input type="hidden" class="form-control" id="exampleInputEmail1" placeholder="Nama Region" name="id" value="<?php echo $id; ?>"><label for="exampleInputEmail1">Nama Region</label> <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Region" name="region_name" value="<?php echo $name; ?>"> </div>  <button type="submit" class="btn btn-default">Submit</button> </form> 
									<?php } ?>
								</div>
							</div>
						</div>
