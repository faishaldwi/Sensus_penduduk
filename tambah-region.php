					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="proses-tambah-region.php" method="POST"> <div class="form-group"> <label for="exampleInputEmail1">Nama Region</label> <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Region" name="region_name"> </div>  <button type="submit" class="btn btn-default">Submit</button> </form> 
								</div>
							</div>
						</div>
					</div>
